...
If it is not working make sure that `/etc/httpd/conf/httpd.conf` has `Listen 8080` in it.  This should have been changed by [Exercise 1.5](../1.5-handlers/README.md)

---
**Navigation**
<br>
[Previous Exercise](../1.6-templates/README.md)
